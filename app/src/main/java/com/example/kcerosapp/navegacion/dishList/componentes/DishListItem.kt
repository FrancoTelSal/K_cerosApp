...
fun DishListItem(plato: Plato) {
    Card(
        ...
        Row(
            ...
            //Condicion if en el que mostrara un icono en caso de que no haya imagen del platillo
            if (plato.imagen == ""){
                Icon(
            ...
            //Columna donde se mostrar la informacion del platillo (Nombre, descripcion y cantidad)
            Column {
